...
| 端点 | 用途 | 响应 |
|------|------|------|
| `POST <local-user-path> | 线索统计 | 本年/本月/本周/本日的新增线索数 |
| `POST <local-user-path> | 商机统计 | 本年/本月/本周/本日的商机数 + 金额 |
| `POST <local-user-path> | 赢单统计 | 本年/本月/本周/本日的赢单商机数 + 金额 |
| `POST <local-user-path> | 进行中商机 | 本年/本月/本周/本日进行中的商机数 + 金额 |
