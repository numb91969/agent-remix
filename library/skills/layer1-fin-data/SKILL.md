...
- `references/fund_flow.md`: SW level-1 daily fund-flow rankings, multi-window aggregates, bounded history
...
| 申万一级行业资金流榜单、1/5/20日累计、历史趋势 | `references/fund_flow.md` | `rank_industry_fund_flows`, `get_industry_fund_flow_series` |
