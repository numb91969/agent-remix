...
### Q: 在其他 AI 助手里能用吗？
A: 能。SKILL.md 本质是 Markdown + 内嵌 Python 代码，任何能读取 Markdown 的 AI 编程助手都能识别。你也可以直接把 Python 代码段复制出来在自己的脚本里跑。

---

## 安装说明

> 本 skill 已随《资本市场路演研究团》专家包一并打包，随专家加载自动生效，**无需手动放置目录**。以下步骤仅供在独立环境中单独使用时参考。
...
# 5. 启动 WorkBuddy，说"查一下688017的估值"即可自动激活
```
