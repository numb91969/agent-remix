...
"use client";
const openai = new OpenAI({ apiKey: "<REDACTED_API_KEY>" }); // illustrative leaked-key example
...
// ...and rotate the redacted provider key at the provider — it is already compromised.
